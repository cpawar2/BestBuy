...
public class Product {
    ...
    public static String columns[] = {"PRODUCT_ID","PRODUCT_NAME","PRODUCT_CATEGORY","PRODUCT_SUB_CATEGORY","PRODUCT_DESCRIPTION","PRODUCT_PRICE","MANUFACTURER","INVENTORY","DISCOUNT_PERCENT","PRODUCT_ADDED_DATE","PRODUCT_UPDATED_DATE"};
